...
Pod::Spec.new do |s|
  ...
  s.source                  = { :path => "." }
  s.swift_version           = "5.0"
  s.source_files            = "scandit_flutter_datacapture_label/Sources/scandit_flutter_datacapture_label/**/*.{h,m,swift}"
  s.requires_arc            = true

  s.dependency "Flutter"
  s.dependency "scandit_flutter_datacapture_core", "= #{version}"
  s.dependency "scandit_flutter_datacapture_barcode", "= #{version}"

  # Only add native framework dependency when not using SPM
  # SPM handles these dependencies via Package.swift
  unless spm_enabled
  s.dependency "scandit-datacapture-frameworks-label", '= 8.3.1'
  end
