...
var dependencies: [Package.Dependency] = [
    ...
    .package(path: "../../scandit-flutter-datacapture-barcode/ios/scandit_flutter_datacapture_barcode"),
]

let labelFrameworksPath = findSharedFrameworksPath().map { "\($0)/scandit-datacapture-frameworks-label" }

if let localPath = labelFrameworksPath {
...
let package = Package(
    ...
    products: [
        .library(
            name: "scandit-flutter-datacapture-label",
            targets: ["scandit_flutter_datacapture_label"]
        )
    ],
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "scandit-flutter-datacapture-barcode", package: "scandit_flutter_datacapture_barcode"),
                .product(name: "ScanditFrameworksLabel", package: "scandit-datacapture-frameworks-label"),
            ],
            path: "Sources/scandit_flutter_datacapture_label"
        )
    ]
)
